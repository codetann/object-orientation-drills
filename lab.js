...
const Ollie = new Cat("Ollie", 2, "white/grey");
...
const Harry = new Wizard("Harry", 18, "Find Food");
...
//Code Here
const samsung = new Phone("Samsung", "s10", 32, "black", 199);
const apple = new Phone("Apple", "iPhone 10", 64, "white", 299);
const lg = new Phone("LG", "v30", 32, "black", 299);
...
//Code Here
const myFirstVehicle = new Vehicle(3, "white", 120000);
...
//Code Here
const myFirstMotorcycle = new Motorcycle(1, "red", 50, "suzuki", true);
...
//Code Here
console.log(blackPearl.isSeaworthy);
